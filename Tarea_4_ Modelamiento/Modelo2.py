...
# =======================================================================
# MODELO 2 con test_size 0.3 y capa adicional
# =======================================================================
import pandas as pd
import numpy as np
...
print(f"📊 Exactitud en test MODELO 2: {accuracy:.2%}")

# 8. Guardar modelo y columnas
model.save("modelo2_sla_tf_norm.h5")
pd.Series(X.columns).to_csv("columnas_modelo2.csv", index=False)
print("✅ Modelo 2 y columnas guardadas")
